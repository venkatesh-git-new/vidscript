...
function covertXmlToJson(xml) {
  return xmlJs.xml2json(xml, { compact: true, spaces: 4 });
}
...
exports.YtTranscript = YtTranscript;
exports.YtTranscriptChrome = YtTranscriptChrome;
